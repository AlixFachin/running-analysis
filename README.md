...
- The javascript doesn't work for Safari browser. (Safari doesn't accept `static` functions).

# Documentation
The documentation is generated by jsDoc and hosted on GitHub pages.
[https://alixfachin.github.io/running-analysis/]

# Dependencies

- (Chartjs)[https://www.chartjs.org]
- (Moment.js)[https://momentjs.com] - Required by Chartjs
- (NoUiSlider.js)[https://refreshless.com/nouislider/] - Range slider widget
